...
file = open('../Data/Settings/param_listMulti2.pickle', 'rb')
...
for i in range(hmtrain):
    ...
    env = Environment.environment(file_map,N_ASV,param_env)
    ...
    if param_agent['sel_model']<2:
        stringNet='DQN'+str(param_agent['freqUpdate'])
    else:
        stringNet='Duel'+str(param_agent['freqUpdate'])
    ...
    param_save={'param_agent':param_agent,'param_env':param_env,'param_map':file_map,'N_ASV':N_ASV }
